...
public class AssignmentListActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragment(new AssignmentListFragment());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == R.id.navigation_crime) {
